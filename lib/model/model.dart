import 'dart:convert';
List<Shopping> shoppingFromJson(String str) => List<Shopping>.from(json.decode(str).map((x) => Shopping.fromJson(x)));

String shoppingToJson(List<Shopping> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
